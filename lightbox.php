...
function merger_assets() {
	wp_enqueue_style( 'merger-css', plugin_dir_url( __FILE__ ) . 'lightbox.css?v=3' );
	wp_enqueue_script( 'merger-js', plugin_dir_url( __FILE__ ) . 'lightbox.js?v=3', array( 'jquery' ), false, true );
}
